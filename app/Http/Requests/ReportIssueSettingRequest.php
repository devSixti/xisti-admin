...
class ReportIssueSettingRequest extends FormRequest
{
    ...
    {
        $rules = [
            'chat_deletion_days_after_issue_resolution' => "required_if:report_chat_history_delete,==,1|numeric|min:1|max:999",
            'general_report_issue_icon' => 'nullable|mimes:png,jpg,jpeg,webp|dimensions:max_width=211,max_height=211|image',
