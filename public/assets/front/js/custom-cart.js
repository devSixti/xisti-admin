...
function setmodalhtml(data){
    ...
    var footer = '<div class="row"><div class="col-md-12 col-xs-12"><span type="button" style="width: 100%" class="btn btn-success addToCart btn-lg btn-md">  <input type="hidden" id="finalpriceAmt" value="'+data.product_amount+'" /> <div class="col-md-12 col-sm-12 col-xs-12 finalpriceAmtTxt add_cart_item_right">'+messages_131+' : '+parseFloat(data.product_amount).toFixed(2)+'</div></span></div></div>';
