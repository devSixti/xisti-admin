...
@section('page-css')
    <style>
        ...
        .btn-success:hover, .btn-success:active, .btn-success:focus {
            background-color: #28c271 !important;
            border-color: #28c271 !important;
...
{{--                                <input type="hidden" name="user_roles" id="user-role" />--}}
                                <p class="text-center social-login">or</p>
...
@section('page-js')
    ...
    <script>
        ...
        function userRole(role){
            ...
            let urlFacebook = '{{url(':user/auth_account_delete/facebook')}}'
            let urlGoogle = '{{url(':user/auth_account_delete/google')}}'
