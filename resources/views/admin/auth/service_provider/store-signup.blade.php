...
@section('page-content')
    <section class="login-block">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form class="md-float-material form-material" action="{{ route('post:store-admin:sign_up_pending') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input type="tel" name="contact_number" id="phone" class="form-control {{ $errors->first()!= Null ? "fill" : '' }}" required="" readonly disabled value="{{ Illuminate\Support\Facades\Auth::guard('store')->user()->country_code.Illuminate\Support\Facades\Auth::guard('store')->user()->contact_number }}">
                                            <input type="hidden" id="contact_numbers" name="contact_numbers" value="{{ Illuminate\Support\Facades\Auth::guard('store')->user()->contact_number }}">
                                            <input type="hidden" id="country_code" name="country_code" value="{{ Illuminate\Support\Facades\Auth::guard('store')->user()->country_code }}">
                                ...
                                <p class="text-inverse text-left"><a href="{{ route('store:logout',[ 'store' ]) }}"><b style="color: mediumseagreen">Sign Out </b></a></p>
                                {{--<p class="text-inverse text-left">Already have an account?<a href="{{ route('get:store-admin:login') }}"><b style="color: mediumseagreen">Sign In </b></a>here!</p>--}}
                            </div>
                        </div>
                    </form>
