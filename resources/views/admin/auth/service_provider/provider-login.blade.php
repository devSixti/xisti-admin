...
@section('page-content')
    <section class="login-block">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form class="md-float-material form-material" method="post" action="{{ route('post:provider-admin:login') }}">
                        {{ csrf_field() }}
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <div class="input-group">
                                        <input type="tel" name="contact_number" style="width: 100%;" class="form-control" required="" id="contact_number" maxlength="10" value="{{old('contact_number') }}" placeholder="Contact Number" >
                                    </div>
                                ...
                                <div class="row m-b-20">
                                    <div class="col-md-6">
                                        <a href="{{ url('provider/auth/facebook') }}" class="btn btn-facebook m-b-20 btn-block"><i class="icofont icofont-social-facebook"></i> Facebook</a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="{{ url('provider/auth/google') }}" class="btn btn-google-plus m-b-20 btn-block"><i class="icofont icofont-social-google"></i> Google</a>
                                    </div>
                                </div>
