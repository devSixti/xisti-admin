...
@section('page-css')
    <style>
        ...
        input[type="radio"] + .label:before {
            /*box-shadow: inset 0 0 0 1px #666565, inset 0 0 0 16px #FFFFFF, inset 0 0 0 16px #28c271;*/
            box-shadow: 0 0 0 0 #28c271, inset 0 0 0 2px #FFFFFF, inset 0 0 0 3px #28c271, inset 0 0 0 16px #FFFFFF, inset 0 0 0 16px #28c271;
        }
        ...
        input[type="radio"] + .label:hover:before {
            ...
            box-shadow: inset 0 0 0 1px #28c271, inset 0 0 0 16px #FFFFFF, inset 0 0 0 16px #28c271;
        }
        ...
        input[type="radio"]:checked + .label:before {
            ...
            box-shadow: inset 0 0 0 1px #28c271, inset 0 0 0 3px #FFFFFF, inset 0 0 0 16px #28c271;

        }

        @keyframes change-size {
            from {
                box-shadow: 0 0 0 0 #28c271, inset 0 0 0 1px #28c271, inset 0 0 0 16px #FFFFFF, inset 0 0 0 16px #28c271;
            }
            to {
                box-shadow: 0 0 0 1px #28c271, inset 0 0 0 1px #28c271, inset 0 0 0 16px #FFFFFF, inset 0 0 0 16px #28c271;
            }
        }
        ...
        @keyframes select-radio {
            ...
            90% {
                box-shadow: 0 0 0 10px #E8FFF0, inset 0 0 0 0 #FFFFFF, inset 0 0 0 1px #28c271, inset 0 0 0 2px #FFFFFF, inset 0 0 0 16px #28c271;
            }
            100% {
                box-shadow: 0 0 0 12px #E8FFF0, inset 0 0 0 0 #FFFFFF, inset 0 0 0 1px #28c271, inset 0 0 0 3px #FFFFFF, inset 0 0 0 16px #28c271;
            }
        }
        ...
        .roles-wrapper-box:hover .roles-label-box {
            ...
            animation-iteration-count: infinite;
            animation-direction: alternate;
            box-shadow: 0 0 0 1px #28c271, 0 0 0 16px #FFFFFF, 0 0 0 16px #28c271;
        }
        ...
        .roles-label-box {
            ...
            border-radius: 7px;
            height: 100%;
            border: 1px solid #28c271;
        }

        @keyframes change-label-size {
            from {
                box-shadow: 0 0 0 0 #28c271, inset 0 0 0 1px #28c271, inset 0 0 0 0 #FFFFFF, inset 0 0 0 0 #28c271;
            }
            to {
                box-shadow: 0 0 0 1px #28c271, inset 0 0 0 1px #28c271, inset 0 0 0 0 #FFFFFF, inset 0 0 0 0 #28c271;
            }
        }
        ...
        .btn-success:hover, .btn-success:active, .btn-success:focus {
            background-color: #DB9E03 !important;
            border-color: #DB9E03 !important;
        }
    </style>
@endsection
                    ...
                    <form class="md-float-material form-material"
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <input type="hidden" id="featured-1" name="roles"
                                       value="1" checked>
...
{{--                                <div class="row">--}}
{{--                                    <div class="col-xl-auto col-xl-12 col-sm-12 col-md-12 roles-box">--}}
...
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="col-xl-4 col-sm-4 col-md-4 roles-box roles-box-last-child">--}}
{{--                                        <div class="roles-wrapper-box">--}}
