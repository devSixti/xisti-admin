                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Driver Search
                                                    Radius (in
                                                    KM):</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Admin Commission
                                                    (in
                                                    %):</label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Admin Hail Commission
                                                    (in
                                                    %):</label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control"
                                                           ...
                                                           placeholder="Admin Hail Commission"
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Ride Expiry Time Out
                                                    (in Mins):</label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control"
                                                           name="ride_expiry"
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Driver Biding Timeout (in Seconds):</label>
                                                <div class="col-sm-8">
                                                    <input type="number" class="form-control"
                                                           name="driver_timeout" min="0" step="0.1"
                                                           required
                                                           id="driver_timeout"
                                                           placeholder="Driver Biding Timeout"
