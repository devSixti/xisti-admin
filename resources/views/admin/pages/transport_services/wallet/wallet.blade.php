                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <form action="{{ route('post:driver-admin:driver_provider_wallet') }}" id="add_wallet_frm" name="add_wallet_frm" method="post" enctype="multipart/form-data">
                                    {{csrf_field() }}
                                    <div class="card">
        ...
        <div class="modal-dialog <!--modal-dialog-centered-->" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class=" col-6">
                        <a type="button" class="float-left btn btnColor btncouponcart" href="{{ route('get:driver-admin:driver_manage_card') }}">Add New Card</a>
                    </div>
                    <div class=" col-6">
