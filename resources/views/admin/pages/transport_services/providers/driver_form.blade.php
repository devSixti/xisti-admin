...
{{--                                                                   {{ ( (isset($driver_detials)) && $driver_detials->login_type != "email") ? "readonly" : "" }}--}}
                                                                   id="email" placeholder="Unique Email" value="{{ (isset($driver_detials)) ? App\Models\User::Email2Stars($driver_detials->email) : old('email') }}">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="form-group row seat_availablity {{ (isset($driver_detials)) && $driver_detials->service_id == 1 ? "show" : "hide" }}">
                                                        <label class="col-sm-4 col-form-label">Seat Availability:</label>
                                                        <div class="col-sm-8">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Vehicle Color:<sup class="error">*</sup></label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" name="vehicle_color" required id="vehicle_color" placeholder="Vehicle Color" value="{{ (isset($driver_detials)) ? $driver_detials->vehicle_color : old('vehicle_color') }}">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input type="email" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" class="form-control" name="payment_email" id="payment_email" placeholder="Email Address for Payment Notification" value="{{ (isset($bank_details)) ? $bank_details->payment_email : old('payment_email') }}">
