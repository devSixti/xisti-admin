                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <form id="main" method="post"
                                      action="{{ route('post:admin:update_language_constant') }}"
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="dt-responsive table-responsive">
                                            <table id="new-cons" class="table table-striped table-bordered nowrap"
                                                ...
                                                @if(isset($language_constant))
                                                    @foreach($language_constant as $key => $singel_language)
                                                        <tr>
                                                            <td>{{ $key + 1 }}</td>
                                                            <td>{{ $singel_language->constant_name }}</td>
                                                            <td>{{ $singel_language->value }}</td>
                                                            <td class="action">
                                                                <a class="render_link"
                                                                   href="{{ route('post:admin:edit_language_constant',$singel_language->id) }}">
