            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>City Area Setting</h5>
                            <span>@if(!isset($city_area_settings))Add @else Edit @endif City Area Setting
                            </span>
                        </div>
                    </div>
                </div>
                        ...
                        <form id="main" method="post"
                            ...
                            @if(isset($id))
                                <input type="hidden" name="id" value="{{$id}}"
                                       placeholder="City Area Setting Id">
                            @endif
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>@if(!isset($city_area_settings))Add @else Edit @endif City Area Setting</h5>
